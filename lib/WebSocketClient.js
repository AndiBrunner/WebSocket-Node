...
var remote_proxy = null;
var http_proxy = (process.env.HTTP_PROXY || '').split(':');
var http_proxy_host = http_proxy[0] || '';
var http_proxy_port = parseInt(http_proxy[1] || 8080) || 8080;

var tunnelingAgent = null;
var httptunnel = null;

if (http_proxy_host != ''){
	httptunnel = require('tunnel');	
	tunnelingAgent = httptunnel.httpsOverHttp({
	  proxy: {
...
WebSocketClient.prototype.connect = function(requestUrl, headers, protocols, origin) {
    var self = this;
